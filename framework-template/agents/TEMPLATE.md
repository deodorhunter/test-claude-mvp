...
# mcpServers: select per plan table (serena+context7 for Python/TS agents; context7-only for infra; neither for doc-writer/critic)
mcpServers:
  - serena:
      type: sse
