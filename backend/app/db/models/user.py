...
from sqlalchemy import Text, TIMESTAMP, ForeignKey, CheckConstraint, UniqueConstraint
...
class User(Base):
    __tablename__ = "users"
    __table_args__ = (
        UniqueConstraint("plone_username", "tenant_id", name="uq_users_plone_username_tenant"),
