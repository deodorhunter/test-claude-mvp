...
class Tenant(Base):
    ...
    plugins: Mapped[list["TenantPlugin"]] = relationship(
        "TenantPlugin", back_populates="tenant"
    )
    quota: Mapped["TenantTokenQuota"] = relationship(
        "TenantTokenQuota", back_populates="tenant", uselist=False
    )
